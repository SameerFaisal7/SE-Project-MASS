...
import com.mass.finansy.Adapters.WeekItemsAdapter;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    totalAmount+=pTotal;
                    totalBudgetAmountTextView.setText("This Month's spending: PKR "+ totalAmount);
                }
            }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    int pTotal = Integer.parseInt(String.valueOf(total));
                    totalAmount+=pTotal;
                    totalBudgetAmountTextView.setText("This week's spending: PKR "+ totalAmount);
                }
            }
