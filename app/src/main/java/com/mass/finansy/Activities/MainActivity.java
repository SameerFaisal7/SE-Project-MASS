package com.mass.finansy.Activities;
...
import com.mass.finansy.Model.Data;
import com.mass.finansy.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Financy");
        ...
        //remainingBudgetTv.setText("PKR "+ (totalAmountBudget - totalAmountToday));
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists() && snapshot.getChildrenCount()>0){
                    for (DataSnapshot ds :  snapshot.getChildren()){
                        ...
                        budgetTv.setText("PKR "+String.valueOf(totalAmountBudget));
                    }
                }else {
                    totalAmountBudget=0;
                    budgetTv.setText("PKR "+String.valueOf(0));
        ...
        expensesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                /*for (DataSnapshot ds :  snapshot.getChildren()){
                    ...
                    todaySpendingTv.setText("PKR "+String.valueOf(totalAmountToday));
                }*/
                ...
                for (DataSnapshot snap:snapshot.getChildren()){
                    ...
                    String sttotal=String.valueOf("PKR "+totalAmountMonth);

                    todaySpendingTv.setText((sttotal));

                }
                //int remains = totalAmountBudget - totalAmountToday;
                // remainingBudgetTv.setText("PKR "+remains);
            }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    int pTotal = Integer.parseInt(String.valueOf(total));
                    totalAmount+=pTotal;
                    todaySpendingTv.setText("PKR "+ totalAmount);
                }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    int pTotal = Integer.parseInt(String.valueOf(total));
                    totalAmount+=pTotal;
                    monthSpendingTv.setText("PKR "+ totalAmount);
                ...
                // remainingBudgetTv.setText("PKR "+totalAmountRemaining);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    int pTotal = Integer.parseInt(String.valueOf(total));
                    totalAmount+=pTotal;
                    weekSpendingTv.setText("PKR "+ totalAmount);
                }
        ...
        personalRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    remainingBudgetTv.setText("PKR " + savings);
